        ...
        {bicycles.map((bicycle, index) => (
          ...
          >
            <Card.Body>
              ...
              <Card.Text>Availability Status: {bicycle.available === 1 ? "Available" : "Not Available"}</Card.Text>
              <Card.Text>Cost per Hour: {bicycle.cost_per_hour}</Card.Text>
              <Card.Text>Added By: {`${bicycle.added_by_firstName} ${bicycle.added_by_lastName}`}</Card.Text>
              <Card.Text>Added By Id: {bicycle.added_by_user_id}</Card.Text> 
              <Card.Text>Added By Username: {bicycle.added_by_username}</Card.Text>
              <Card.Text>Added By Type: {bicycle.added_by_usertype}</Card.Text>
              <Card.Text>Created Time: {convertTimestampToDateTime(bicycle.created_time)}</Card.Text>
